...
public class IndividualTicketController {
    ...
    @ResponseBody
    public void individualTicket(HttpServletResponse response) throws IOException {
        ...
        reportService.export(INDIVIDUAL_COLUMN,INDIVIDUAL_TITLE,individualTicketVos,response);
    }
}
